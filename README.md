...
- **[MiniMax H3 1K prompt index](https://github.com/yangzhou-chaofan/minimax-h3-1000-prompts)** – Curated 1K text-to-video prompt dataset for MiniMax H3: prompt-structure anatomy, 10 hand-picked reusable prompts, and a model comparison.
